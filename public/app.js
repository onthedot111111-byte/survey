...
const SURVEY_INTRO_TEXT = `안녕하세요. 고양국제고 3학년 정주훈입니다. 

본 설문은 사회 탐구 방법 수업에서 AI 기술이 활용되는 재판 및 의사결정 상황에 대한 청소년(만14세~만18세)의 인식을 조사하기 위해 제작되었습니다. 참가자는 하나의 사례를 읽고 자신의 생각을 응답하게 되며, 총 30문항으로 예상 소요 시간은 약 2분 정도입니다. 응답하신 내용은 통계법 제33조 및 제34조에 의해 보호되고, 연구 목적 이외에는 사용되지 않으며, 연구 종료와 동시에 폐기됩니다.
...
const SHARE_RULES = [
  "설문을 공유한 뒤 공유 화면을 사진으로 인증해 주세요.\n(개인톡으로 여러 명에게 공유한 경우, 1인에게 공유 선택 후 보낸 인증 사진을 여러장 업로드)",
